                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr v-for="(org,index) in org_list" :key="'org'+org.org_id">
                                ...
                                <td>{{org.org_name}}</td>
                                <td>
                                    <button class="btn btn-defaule btn-xs" v-if="org.isExcellent==0" @click="setExcellent(org)">评优</button>
                                    <button class="btn btn-warning btn-xs" v-if="org.isExcellent==1" @click="setExcellent(org)">评优</button>
                                </td>
