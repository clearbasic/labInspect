                ...
                <div class="addMenu" v-if="showAdd">
                    <div class="form-inline">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="newRole.name" id="title" placeholder="菜单名称">
                        </div>
                        <div class="form-group">
                            <label class="control-label">上级菜单</label>
                            <select class="form-control" v-model="newRole.pid">
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input type="radio" v-model="newRole.status" value="yes" class="ace">
                                <span class="lbl">
                                    开启
                                </span>
                            </label>
                            <label>
                                <input type="radio" v-model="newRole.status" value="no" class="ace">
                                <span class="lbl">
                                    禁用
                                </span>
                            </label>
